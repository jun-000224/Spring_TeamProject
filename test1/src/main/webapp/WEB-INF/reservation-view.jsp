...
<head>
  ...
  <style>
    ...
    .title-input { font-size:1rem; padding:8px 10px; border:1px solid #ccc; border-radius:8px; flex:0 0 260px; max-width:260px; } /* ⬅ 너비 축소 */
