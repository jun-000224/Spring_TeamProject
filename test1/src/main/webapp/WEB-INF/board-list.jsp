...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .board-filter button:hover { background: var(--primary-hover); }
    ...
    /* 열 폭 */
    .col-num   { width: 88px; text-align: center; color:#334155; }
    .col-author{ width: 160px; text-align: center; }
    .col-like  { width: 110px; text-align: center; color:#0f766e; font-weight:700; }
    .col-cnt   { width: 110px; text-align: center; color:#475569; }
    .col-date  { width: 150px; text-align: center; color:#64748b; }
    ...
    .type-N { background: #fef3c7; color:#92400e; }  /* 공지 */
    .type-F { background: #e2e8f0; color:#475569; }  /* 자유 */
    .type-Q { background: #dcfce7; color:#166534; }  /* 질문 */
    .type-SQ{ background: #f3e8ff; color:#6b21a8; }  /* 문의 */
    ...
    @media (max-width: 760px) {
      .board-filter { width: 92%; }
      table { width: 92%; }
      .pagination { width: 92%; }
      .write-wrap { width: 92%; justify-content: center; }
    }
  </style>
</head>
...
<div id="app">
  ...
  <div class="pagination">
    ...
    <a href="javascript:;" class="page-num"
